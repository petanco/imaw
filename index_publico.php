			...
			<div id="page-wrapper">
				...
				<header id="header" class="alt">
						...
						<nav>							
							...
							<a href="recursos/generic.html">Actualidad</a>							
							<a href="recursos/login.php">Iniciar Sesión</a>
							<a href="recursos/sign_up.php">Registrarse</a>							
						</nav>
					</header>
					...
					<!-- <nav id="menu">
						<div class="inner">
							...
							<ul class="links">
								...
								<li><a href="generic.html">Actualidad</a></li>							
								<li><a href="recursos/login.php">Iniciar Sesión</a></li>
								<li><a href="recursos/sign_up.php">Registrarse</a></li>
							</ul>
